...
//This program puplishes what the user writes into the chatter node
int main(int argc, char *argv[])
{
  ...
  while (ros::ok())
  {
    ...
    std::cin >> msg.data, msg2.data; //Add user input to the data of msg

    ROS_INFO(" [%c] , [%c] ", msg.data, msg2.data);
